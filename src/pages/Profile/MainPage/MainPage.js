...
function MainPage({ user }) {
    ...
    useEffect(() => {
        ...
        fetch(`https://twitter-clone-backend-ruby.vercel.app/userPost?email=${user?.email}`)
            .then(res => res.json())
            .then(data => {
                setPosts(data);
            })
    ...
    const handleUploadCoverImage = (e)=>{
        ...
        axios.post("https://api.imgbb.com/1/upload?key=8931007163c55e54bcdb83f4f1479778", formData)
        .then(res => {
            ...
            setIsLoading(false);
            if (url){
                axios.patch(`https://twitter-clone-backend-ruby.vercel.app/userUpdates/${user?.email}`,userCoverImage)
            }
        })
    }
    const handleUploadProfileImage = (e)=>{
        ...
        .then(res => {
            ...
            setIsLoading(false);
            if (url){
                axios.patch(`https://twitter-clone-backend-ruby.vercel.app/userUpdates/${user?.email}`,userProfileImage)
            }
        })
    }
